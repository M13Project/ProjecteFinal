...
public class LoginController {
    ...
    public boolean validateUser(String userTypedPassword, boolean firstTimeLogging, List<Usuari> u) {
        ...
        if (firstTimeLogging) {
            //Aqu� les contrasenyes venen de la base de dades remota. La classe PersistanceManager s'ocupa de recuperar aquesta info. En comptes de new ArrayList s'ha de posar un m�tode de PersistanceManager.
