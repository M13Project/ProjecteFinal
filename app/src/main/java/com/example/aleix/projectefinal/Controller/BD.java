...
/**
 * Created by Aleix on 11/05/2015.
 */
public class BD extends SQLiteOpenHelper {
    ...
    String sqlCreate ="CREATE TABLE Clients (Id INTEGER PRIMARY KEY, Nom TEXT, Cognom TEXT, Edat INTEGER, DataProperaVisita Datetime); " +
            ...
            "CREATE TABLE Producte (Id INTEGER PRIMARY KEY, Nom TEXT, Descompte DOUBLE, Imatge TEXT, Habilitat TEXT, CategoriaId INTEGER, FOREIGN KEY(CategoriaId) REFERENCES Categoria(Id)); " +
